...
from .mnist_sequential_comparator import MnistSequentialComparator
...
if __name__ == '__main__':
    ...
    comparator = MnistSequentialComparator(K, L, learning_rate=0.0001, n_train_sample=100, n_validation_sample=100,
                                           ...
                                           learnt_dictionary=False, normalise_dictionary=True)
    ...
    np.savez('time_100_train_20_layers_K_250_rand_dict_norm',
