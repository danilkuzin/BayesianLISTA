...
from tf.experiments.mnist.mnist_sequential_comparator import MnistSequentialComparator
...
if __name__ == '__main__':
    ...
    comparator = MnistSequentialComparator(K, L, learning_rate=0.0001, n_train_sample=100, n_validation_sample=100,
                                           train_freq=True, train_shared_bayes=True, use_ista=True,
                                           use_fista=True, save_history=False, initial_lambda=0.1,
                                           normalise_dictionary=True)
    ...
    np.savez('time_100_train_20_layers_K_100_rand_dict_norm',
