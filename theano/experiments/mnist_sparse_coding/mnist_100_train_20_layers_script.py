...
from experiments.mnist_sparse_coding.mnist_sequential_comparator import MnistSequentialComparatorSparseCoding
...
if __name__ == '__main__':
    ...
    comparator = MnistSequentialComparatorSparseCoding(D, L, learning_rate=0.0001, n_train_sample=100, n_validation_sample=100,
    ...
    np.savez('time_100_train_20_layers',
