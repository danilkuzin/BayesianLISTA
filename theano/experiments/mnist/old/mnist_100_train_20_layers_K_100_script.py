...
if __name__ == '__main__':
    ...
    np.savez('time_100_train_20_layers_K_100', lista_time=lista_time, sh_bayes_time=sh_bayes_time, lista_nmse=lista_nmse, lista_f_meas=lista_f_meas, sh_bayes_nmse=sh_bayes_nmse, sh_bayes_f_meas=sh_bayes_f_meas)
