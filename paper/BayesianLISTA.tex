...
\begin{figure*}[t]
\subfloat[NMSE on train]{\includegraphics{graphics/synthetic_number_of_layers/nmse_train}}
~
\subfloat[NMSE on validation]{\includegraphics{graphics/synthetic_number_of_layers/nmse_validation}}
\newline
\subfloat[F measure on train]{\includegraphics{graphics/synthetic_number_of_layers/f_measure_train}}
~
\subfloat[F measure on validation]{\includegraphics{graphics/synthetic_number_of_layers/f_measure_validation}}
